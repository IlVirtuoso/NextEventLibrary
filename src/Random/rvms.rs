...
pub const SQRT2PI: f64= (2*PI).sqrt();              // ///* sqrt(2 * pi) */
...
pub fn pdfBernoulli(p :f64,x :f64) -> f64{
 // =======================================
...
pub fn cdfBernoulli(p : f64,x : f64){
 // =======================================
 // * NOTE: use 0.0 < p < 1.0 and 0 <= x <= 1 
 // * =======================================
 if x==0{1.0-p}
...
pub fn idfBernoulli(p : f64,u : f64){
 // =========================================
...
pub fn pdfEquilikely(a,b,x):
 // ============================================ 
 // * NOTE: use a <= x <= b 
 // * ============================================
 return (1.0 / (b - a + 1.0))

pub fn cdfEquilikely(a,b,x):
 // ============================================
 // * NOTE: use a <= x <= b 
 // * ============================================
 return ((x - a + 1.0) / (b - a + 1.0))

pub fn idfEquilikely(a,b,u):
 // ============================================ 
...
pub fn cdfGeometric(p,x):
 // ===================================== 
 // * NOTE: use 0.0 < p < 1.0 and x >= 0 
 // * =====================================
 return (1.0 - exp((x + 1) * log(p)))

pub fn idfGeometric(p,u):
 // ========================================= 
 // * NOTE: use 0.0 < p < 1.0 and 0.0 < u < 1.0 
 // * =========================================
...
pub fn cdfPascal(n,p,x):
 // =========================================== 
 // * NOTE: use n >= 1, 0.0 < p < 1.0, and x >= 0 
 // * ===========================================
 return (1.0 - InBeta(x + 1, n, p))

pub fn idfPascal(n,p,u):
 // ================================================== 
